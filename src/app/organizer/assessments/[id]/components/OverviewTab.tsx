        ...
        <div className="space-y-8 pb-10">
            ...
            <div className="space-y-5">
                <div className="flex items-center justify-between px-1">
                    <div>
                        <h2 className="text-xl font-black text-foreground tracking-tight">Curriculum Breakdown</h2>
                    ...
                    return (
                        <motion.div
                            ...
                            className={`group border rounded-2xl overflow-hidden transition-all duration-300 ${
                                isExpanded ? 'border-primary/30 bg-card shadow-lg' : 'border-border bg-card/50 hover:border-primary/20'
                            }`}
                        >
                            <button
                            ...
                            >
                                <div className="flex items-center gap-5">
                                    <div
                                        className="w-12 h-12 rounded-2xl flex items-center justify-center font-black text-lg text-white shadow-inner"
                                        style={{ 
                                                    ...
                                                    {section.questions && section.type !== 'coding' && section.questions.map((question: Question, qIndex: number) => (
                                                        <div key={question.id} className="bg-card border border-border rounded-xl p-5 shadow-sm hover:border-primary/20 transition-all">
                                                            <div className="flex items-start gap-4">
                                                                <div className="flex items-center justify-center w-8 h-8 bg-primary text-primary-foreground rounded-lg font-black text-xs shrink-0 shadow-md">
                                                                    {qIndex + 1}
                                                                </div>
                                                                <div className="flex-1">
                                                                    ...
                                                                    {question.image && (
                                                                        <div className="mb-4 overflow-hidden rounded-xl border border-border shadow-inner bg-muted/20">
                                                                            <img src={question.image} alt="Question Context" className="max-h-72 w-auto mx-auto object-contain" />
                                                                        </div>
                                                                    )}
                                                                    ...
                                                                    {question.options && question.options.length > 0 && (
                                                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                                            {question.options.map((option: string, optIndex: number) => {
                                                                                ...
                                                                                return (
                                                                                    <div key={optIndex} className={`flex items-center gap-3 p-3 rounded-xl text-sm transition-all border ${
                                                                                        isCorrect ? 'bg-emerald-500/10 border-emerald-500/30 text-emerald-700 shadow-sm' : 'bg-muted/40 border-border/50 text-foreground'
                                                                                    }`}>
                                                                                        <div className={`w-6 h-6 flex items-center justify-center rounded-lg font-bold text-[10px] ${
                                                                    ...
                                                                    {question.type === 'fill_in_the_blank' && question.correctAnswer && (
                                                                        <div className="mt-4 flex items-center gap-3 p-3 rounded-xl bg-emerald-500/5 border border-emerald-500/20 border-dashed">
                                                                            ...
                                                                            <span className="text-sm font-black text-emerald-600">{question.correctAnswer}</span>
                                                                        </div>
                                                                    )}
                                                                </div>
                                                            </div>
